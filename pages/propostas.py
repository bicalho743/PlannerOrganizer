...
def show():
    """Função principal que mostra a seção de Propostas"""
    st.title("PROPOSTAS")
...
def mostrar_lista_propostas():
    ...
    try:
        ...
        # Não vamos mostrar todas as colunas do banco, apenas as mais importantes
            ...
            with st.form("adicionar_acrescimo"):
                ...
                if submited_acrescimo:
                    try:
                        ...
                        if tipo_acrescimo == "Fornecedor" and 'fornecedor_id' in locals():
                            # Buscar ID do fornecedor
                            parametros['fornecedor_id'] = fornecedores[fornecedores['nome'] == fornecedor_id]['id'].iloc[0]
                        
                        if tipo_acrescimo == "Assistente" and 'assistente_id' in locals():
                            # Buscar ID do assistente
                            parametros['assistente_id'] = assistentes[assistentes['nome'] == assistente_id]['id'].iloc[0]
