    ...
    for _, acao in df_acoes.iterrows():
        ...
        with col_obs:
            ...
            with btn_cols[1]:
                ...
                if gratuito:
                    st.markdown('<div style="padding:4px 0;height:32px;display:flex;align-items:center;"><span style="background:#c6f6d5;color:#22543d;padding:6px 10px;border-radius:6px;font-weight:600;font-size:0.85rem;display:inline-block;">➕ Gratuito</span></div>', unsafe_allow_html=True)
            
            with btn_cols[2]:
                # Expander "Dica estratégica" - renderizado se houver hint
                if hint:
