...
- [st.dataframe + st.dialog reopen trap](streamlit-dataframe-dialog.md) — abrir dialog ao selecionar linha reabre em loop ao fechar; usar nonce de estado (só abrir quando sel_pid muda).
